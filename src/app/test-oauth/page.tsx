...
export default function TestOAuth() {
  ...
  const handleTestProductionOAuth = () => {
    ...
    console.log('Attempting Production OAuth with URL:', authUrl)
  ...
  const handleTestWindowOpen = () => {
    ...
    try {
      ...
      console.log('Testing window.open with:', testUrl)
      window.open(testUrl, '_system')
    } catch (error) {
      console.error('window.open test failed:', error)
      alert('window.open test failed: ' + (error instanceof Error ? error.message : String(error)))
    }
  }
