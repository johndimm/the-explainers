  ...
  return (
    <div>
      <style jsx>{`
        ...
        @media (max-width: 1200px) { .grid { grid-template-columns: repeat(2, 1fr); gap: 14px; } }
        @media (max-width: 1024px) { .grid { grid-template-columns: repeat(2, 1fr); gap: 12px; } }
        ...
        .imgWrap { position: relative; background: #fafafa; padding: 8px; border-top: 2px solid var(--ink); }
        ...
        .caption { background: var(--cream); border-bottom: 2px solid var(--ink); padding: 8px 10px; font-weight: 700; color: #111827; font-size: 13px; line-height: 1.5; font-style: italic; }
        ...
        <div style={{ maxWidth: '1120px', margin: '0 auto' }}>
          ...
          <section className="grid">
            {captions.map((caption, idx) => {
              const imageNumber = idx + 1 // simple 1:1 mapping for first 4 images
